...
const projects = [
  ...
  {
    id: 2,
    title: 'Letteral - 社内問題可視化アプリ',
    description: 'リアルタイム返信機能を備えた匿名進捗共有プラットフォーム。JWT認証とWebSocketによるリアルタイム通信を実装。',
    technologies: ['Next.js 15', 'TypeScript', 'Spring Boot 3.5', 'MySQL', 'WebSocket', 'JWT認証'],
    category: 'Webアプリケーション',
    status: '完成',
    featured: true,
    imageSrc: '/images/projects/letteral.png',
    imageColor: 'from-purple-400 to-pink-400',
    demoUrl: 'https://letteral.vercel.app/',
    githubUrl: 'https://github.com/hera-16/letteral',
    demoVideoUrl: '/videos/Letteral-demo.mp4'
  },
  {
    id: 3,
    title: 'Leaving Work - 勤怠管理システム',
    description: '静的HTMLとCSSで構築された勤怠管理システム。ユーザー登録、編集、履歴表示機能を備えたクライアントサイドアプリケーション。',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'LocalStorage', 'レスポンシブデザイン'],
    category: 'Webアプリケーション',
    status: '完成',
  ...
  },
  {
    ...
    description: '地元遠賀郡の食材を使用した手作りおむすび専門キッチンカーの公式Webサイト。CSS GridとFlexboxでモダンなデザインを実現。',
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'CSS Grid', 'Flexbox', 'SEO対応'],
    category: 'Webサイト',
    status: '完成',
  ...
  },
  {
    id: 5,
    title: 'ポケモン図鑑',
    description: 'PokeAPIを使用したインタラクティブなポケモン図鑑。Fetch APIとAsync/Awaitで非同期データ取得を実装したSPAアプリケーション。',
    technologies: ['JavaScript ES6+', 'HTML5', 'CSS3', 'Fetch API', 'PokeAPI', 'Async/Await'],
    category: 'Webアプリケーション',
    status: '完成',
